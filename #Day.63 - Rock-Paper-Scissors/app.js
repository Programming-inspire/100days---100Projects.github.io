const message = document.querySelector('.message');
        ...
        function playGame(e){
            ...
            score.innerHTML = '<span class="player">Player: [ ' + winnerScores[0]+ ' ]<span>' + ' <span class="computer">Computer: [ ' + winnerScores[1] + ' ]<span>';

            //output player and computer's selections
            messenger('<span class="player">Player: <strong><span>' + playerSelection + '</strong>' + '<span class="vs"> Vs</span> ' + '<span class="computer"> Computer: <strong>' + computerSelection + '</strong><span><br>' +'<span class="res">' + result +'</span>');
        }
